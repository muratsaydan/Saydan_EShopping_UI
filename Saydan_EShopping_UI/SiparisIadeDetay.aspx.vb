Imports System.Data
Partial Class SiparisIadeDetay
	...
	Protected Sub btnIade_Click(sender As Object, e As EventArgs) Handles btnIade.Click
		Dim cmdstr As String = "UPDATE ODEME_ISLEMLERI set IadeMi=1, IadeSEbebi='" + drpIadeSebebi.SelectedValue + " , " + txtAciklama.Text + "' where PaymentStatus='SUCCESS' and SiparisKodu=" + SiparisKodu.ToString
		Saydanclass.ExecSQL(cmdstr)
		Response.Redirect("SiparisIade.aspx")
	End Sub
End Class
