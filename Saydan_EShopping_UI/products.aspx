<%@ Page Title="" Language="VB" EnableEventValidation="false"  MasterPageFile="~/Master1.master" AutoEventWireup="false" CodeFile="products.aspx.vb" Inherits="products" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
	<div class="span9">
		...
		<h3>
			<asp:Label ID="lblUrunKategorisi" runat="server">Products Name </asp:Label><small class="pull-right"> Bu kategoride
				<asp:Label ID="lblUrunAdedi" runat="server">40</asp:Label>
				ürün bulunmaktadır.</small></h3>
		<hr class="soft" />
