<%@ Page Title="" EnableEventValidation="false"  Language="VB" MasterPageFile="~/Master1.master" AutoEventWireup="false" CodeFile="product_details.aspx.vb" Inherits="product_details" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
	...
	<div class="row">	  
			<div id="gallery" class="span3">
				<asp:HyperLink ID="hypAnaResim" runat="server" NavigateUrl="themes/images/products/large/f1.jpg" ToolTip="Fujifilm FinePix S2950 Digital Camera" ImageUrl="themes/images/products/large/3.jpg"></asp:HyperLink>
			<div id="differentview" class="moreOptopm carousel slide">
                <div class="carousel-inner">
                  <div class="item active">
				<asp:HyperLink ID="hypResim1" runat="server" NavigateUrl="themes/images/products/large/f1.jpg" ToolTip="Fujifilm FinePix S2950 Digital Camera" ImageUrl="themes/images/products/large/f1.jpg" width="29%"></asp:HyperLink>
				<asp:HyperLink ID="hypResim2" runat="server" NavigateUrl="themes/images/products/large/f2.jpg" ToolTip="Fujifilm FinePix S2950 Digital Camera" ImageUrl="themes/images/products/large/f2.jpg" width="29%"></asp:HyperLink>
				<asp:HyperLink ID="hypResim3" runat="server" NavigateUrl="themes/images/products/large/f3.jpg" ToolTip="Fujifilm FinePix S2950 Digital Camera" ImageUrl="themes/images/products/large/f3.jpg" width="29%"></asp:HyperLink>
...
<%--			 <div class="btn-toolbar">
			...
			<div class="span6">
				<h3 id="lblUrunAdi" runat="server" >Fujifilm FinePix S2950 Digital Camera  </h3>
<%--				<small id="lblKisaAciklama1" runat="server" >- (14MP, 18x Optical Zoom) 3-inch LCD</small>--%>
				<hr class="soft"/>
				<div class="form-horizontal qtyFrm">
				  <div class="control-group">
					<label class="control-label"><span id="lblFiyat" runat="server" >$222.00</span></label>
					<div class="controls">Miktar : 
						<asp:TextBox ID="txtAdet" runat="server" width="75"  ></asp:TextBox>
					<%--<input type="number" class="span1" placeholder="Adet"/>--%>
						<asp:LinkButton ID="btnSepet" runat="server" CssClass="btn btn-large btn-primary pull-right">Sepete Ekle</asp:LinkButton>
				...
				<hr class="soft"/>
										<asp:LinkButton ID="btnHemenAl" runat="server" CssClass="btn btn-large btn-warning pull-right">Hemen Al</asp:LinkButton>
				<h4 id="lblMiktar" runat="server" >100 Adet</h4>
...
<%--				<hr class="soft clr"/>--%>
				<p>
				<span id="lblKisaAciklama" runat="server" >
...
<%--            <ul id="productDetail" class="nav nav-tabs">
            ...
            <div id="myTabContent" class="tab-content">
			  ...
			  <h4> Detaylı Ürün Bilgisi</h4>
			    <span id="lblDetay" runat= "server" >
...
<%--		<div class="tab-pane fade" id="profile">
		...
		<div class="" style="background-color:tomato; padding:10px;" id="divyonetici" runat="server" >
			<asp:CheckBoxList ID="chkSecim" runat="server" Width="250" RepeatLayout="Flow" CssClass="muratozel ">
				<asp:ListItem>İndirimdeki Ürünler Listesine Ekle</asp:ListItem>
				<asp:ListItem>Özel Ürünler Listesine Ekle</asp:ListItem>
			</asp:CheckBoxList>
			<br /><br />
			<asp:HyperLink ID="hypUrunDetay" runat="server" Target="_blank"  >Ürün Detay sayfasına Git</asp:HyperLink><br /><br />
			<asp:HyperLink ID="hypBanneraEkle" runat="server" Target="_blank"  >Bu Ürünü Ana Sayfa Slaytlarına Ekle</asp:HyperLink><br /><br />
