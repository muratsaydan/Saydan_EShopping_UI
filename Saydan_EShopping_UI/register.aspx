<%@ Page Title="" Language="VB" MasterPageFile="~/Master1.master" AutoEventWireup="false" CodeFile="register.aspx.vb" Inherits="register" %>
...
<%--				<input type="hidden" name="email_create" value="1">
				...
				<asp:LinkButton ID="btnRegister" runat="server" CssClass="btn btn-large btn-default">Üye Ol</asp:LinkButton>
			</div>
		</div>		
